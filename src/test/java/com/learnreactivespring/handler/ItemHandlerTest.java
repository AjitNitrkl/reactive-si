...
public class ItemHandlerTest {
    ...
    public void getAllItems()  {
        webTestClient.get().uri(ITEM_FUNC_ENDPOINT_V1)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getAllItems_2()  {
        Flux<Item> fluxItems =  webTestClient.get().uri(ITEM_FUNC_ENDPOINT_V1)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getAItemTest(){
        ...
        webTestClient.get().uri(ITEM_FUNC_ENDPOINT_V1.concat("/{id}"), "123")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getAItemNotFoundTest(){
        webTestClient.get().uri(ITEM_FUNC_ENDPOINT_V1.concat("/{id}"), "1234")
                .exchange()
    ...
    public void createItemTest(){
        ...
        webTestClient.post().uri(ITEM_FUNC_ENDPOINT_V1)
    ...
    public void deleteItemTest(){
        webTestClient.delete().uri(ITEM_FUNC_ENDPOINT_V1.concat("/{id}"),"123")
    ...
    public void updateItemTest(){
        ...
        webTestClient.put().uri(ITEM_FUNC_ENDPOINT_V1.concat("/{id}"),"123")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .accept(MediaType.APPLICATION_JSON_UTF8)
    ...
    public void updateItemTestNotFound(){
        Item newItem = Item.builder().id("123").description("Bose Portal Speaker ").price(399.0).build();
        webTestClient.put().uri(ITEM_FUNC_ENDPOINT_V1.concat("/{id}"),"345")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .body(Mono.just(newItem),Item.class)
                .exchange()
    ...
    @Test
    public void runTimeException_1(){
        webTestClient.get().uri("/fun/runTimeException")
                .exchange()
                .expectStatus().is5xxServerError()
